...
def converter_data_para_banco(data_str: Optional[str]) -> str:
    """Converte data de DD/MM/YYYY para YYYY-MM-DD (formato banco).

    Args:
        data_str: String com data no formato DD/MM/YYYY ou YYYY-MM-DD

    Returns:
        Data no formato YYYY-MM-DD ou string vazia se inválida

    Note:
        Esta função mantém compatibilidade com código legado.
        Para novas implementações, use parse_iso_date() de data.helpers.
    """
