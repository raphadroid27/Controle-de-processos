...
from .processos_data_service import (buscar_registros_filtrados,
...
from .processos_table_edit import (LinhaProcessoEdicao, extrair_campos_linha,
                                   obter_registro_id, validar_edicao_celula)
