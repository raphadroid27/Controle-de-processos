...
from PySide6.QtWidgets import (QComboBox, QFrame, QHBoxLayout, QLineEdit,
                               QPushButton)
...
def criar_filtros(
    *,
    ...
    entry_processo = QLineEdit(frame)
